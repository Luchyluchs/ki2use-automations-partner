  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-card-border bg-background hover:bg-muted text-foreground shadow-soft",
        ghost: "hover:bg-muted text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "gradient-primary text-primary-foreground hover:shadow-primary font-semibold text-base transform hover:scale-[1.02] transition-all duration-300",
        cta: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-card font-medium tracking-normal",
        soft: "bg-muted text-muted-foreground hover:bg-card border border-card-border font-medium",
