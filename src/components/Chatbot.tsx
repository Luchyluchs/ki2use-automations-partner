...
const Chatbot = () => {
  ...
  const webhookUrl = "https://luckyluchs.app.n8n.cloud/webhook-test/8e2e75fc-67cd-4eda-9588-f6bb753d6aa4";
    ...
    try {
      ...
      if (response.ok) {
        ...
        const botMessage: Message = {
          ...
          text: data || "Vielen Dank für Ihre Nachricht! Unser Team wird sich schnellstmöglich bei Ihnen melden.",
          isUser: false,
          timestamp: new Date()
        };
        ...
        <div className="fixed bottom-24 right-6 w-96 h-[500px] bg-card border border-card-border rounded-2xl shadow-elevated z-50 flex flex-col animate-scale-in">
          ...
          <div className="p-4 border-t border-card-border bg-card rounded-b-2xl">
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">
              🤖 Automatisiert mit n8n - Live-Demo unserer KI-Kompetenz
            </p>
          </div>
        </div>
      )}
