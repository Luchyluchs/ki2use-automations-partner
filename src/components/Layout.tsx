...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigation = [
    { name: "Start", href: "/" },
    { name: "Standard-KI-Agenten", href: "/standard-agenten" },
    { name: "Maßgeschneiderte Agenten", href: "/massgeschneiderte-agenten" },
    { name: "KI-Schulungen", href: "/ki-schulungen" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground max-w-md">
                KI-Agenten & Schulungen für deutsche KMU. Prozesse automatisiert mit n8n – 
                auch bei uns! Ihre effiziente Lösung für mehr Produktivität.
              </p>
            </div>
