  ...
  return (
    <div className="bg-card border border-card-border rounded-2xl p-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h3 className="text-2xl font-bold">ROI-Rechner für maßgeschneiderte Lösung</h3>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-6 bg-gradient-to-br from-accent/5 to-secondary/5">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span>Entwicklungskosten:</span>
                <span>€{customAgentCosts.setup.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span>Monatliche Wartung:</span>
                <span>€{customAgentCosts.monthly}/Monat</span>
              </div>
              <div className="flex justify-between">
                <span>Gesamtinvestition (1. Jahr):</span>
                <span className="font-semibold">€{totalInvestmentFirstYear.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
