      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl">
          ...
          <div className="scroll-reveal stagger-delay-1 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-3xl space-y-4 sm:space-y-6">
            ...
            <p>
              Mit IHK-Zertifizierung als KI-Manager unterstützt KI2USE Unternehmen dabei, 
           ...
           <div className="scroll-scale stagger-delay-2 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 mt-8 sm:mt-12">
             <div className="flex items-start space-x-3 sm:space-x-4 p-4 sm:p-5 border border-card-border/30 rounded-xl hover:border-primary/30 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-muted-foreground font-light">Geprüfter KI-Manager – IHK-zertifiziert</p>
              </div>
            </div>
             <div className="flex items-start space-x-3 sm:space-x-4 p-4 sm:p-5 border border-card-border/30 rounded-xl hover:border-primary/30 transition-all duration-300">
