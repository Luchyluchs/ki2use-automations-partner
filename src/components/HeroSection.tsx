...
const HeroSection = () => {
  useScrollReveal();
  useParallax();
  return <section className="relative overflow-hidden min-h-screen flex items-center bg-gradient-to-br from-background via-muted/30 to-background">
      {/* Parallax Background Elements */}
      <div className="absolute inset-0 bg-grid-pattern opacity-[0.02] parallax-slow"></div>
      <div className="absolute top-20 right-10 w-72 h-72 bg-primary/5 rounded-full blur-3xl parallax-slow"></div>
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-accent/5 rounded-full blur-3xl parallax-slow"></div>
