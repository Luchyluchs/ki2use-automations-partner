        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center scroll-reveal">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed font-light max-w-3xl mx-auto">
              ...
              von direkten <span className="font-semibold text-foreground">Zuschüssen</span> bis hin zur <span className="font-semibold text-foreground">Übernahme von Gehältern</span> für neue KI-Stellen. 
